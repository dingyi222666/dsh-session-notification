...
export const zh = {
  ...
  'main.title': '只提醒主会话',
  'main.desc': '开启后只提醒主会话，并行运行的子会话（subagent）不打扰；关闭后所有子会话也会提醒。',
  'wait.title': '等子会话全部结束',
  'wait.desc': '主会话先告一段落、但子会话还在跑时不提醒，等所有子会话都结束后再提醒一次；失败仍会立即提醒。',
  'sound.title': '提示音',
  'sound.desc': '有通知时播放声音。',
  'volume.title': '音量',
  'volume.desc': '提示音整体音量。',
...
export const en = {
  ...
  'main.title': 'Main session only',
  'main.desc': 'When on, only the main session alerts and parallel subagents stay silent; turn it off to hear from every subagent too.',
  'wait.title': 'Wait for all subagents',
  'wait.desc': 'Hold the alert while the main session pauses with subagents still running, and alert once when they have all finished; failures still alert immediately.',
  'sound.title': 'Sound',
